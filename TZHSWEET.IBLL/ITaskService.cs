...
{
   public interface ITaskService : IBaseService<PM_Task>
    {
        /// <summary>
        /// 根据条件获取所有任务
        /// </summary>
        ...
        /// <returns></returns>
        IEnumerable<PM_Task> GetAllTasks(LigerUIGridRequest request, out int Count);
        ...
        /// <returns></returns>
        PM_Task GetTaskInfo(int TaskID);
