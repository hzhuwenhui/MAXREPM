...
namespace TZHSWEET.Entity
{
    ...
    public partial class PM_Department: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        private void FixupPM_Project(PM_Project previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.PM_Department.Contains(this))
            {
                previousValue.PM_Department.Remove(this);
            }
    
            if (PM_Project != null)
            {
                if (!PM_Project.PM_Department.Contains(this))
                {
                    PM_Project.PM_Department.Add(this);
                }
