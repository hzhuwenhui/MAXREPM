...
namespace TZHSWEET.Entity
{
    ...
    public partial class PM_Contract: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region 基元属性
        ...
        public string ContractTitle
        {
            ...
            set
            {
                if (_contractTitle != value)
                {
                    _contractTitle = value;
                    OnPropertyChanged("ContractTitle");
                }
            }
        }
        ...
        public string ContractProfile
        {
            ...
            set
            {
                if (_contractProfile != value)
                {
                    _contractProfile = value;
                    OnPropertyChanged("ContractProfile");
                }
            }
        }
        ...
        [DataMember]
        public Nullable<double> ContractAmount
        {
            get { return _contractAmount; }
            set
            {
                if (_contractAmount != value)
                {
        ...
        private Nullable<double> _contractAmount;
        ...
        private void FixupPM_Project(PM_Project previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.PM_Contract.Contains(this))
            {
                previousValue.PM_Contract.Remove(this);
            }
    
            if (PM_Project != null)
            {
                if (!PM_Project.PM_Contract.Contains(this))
                {
                    PM_Project.PM_Contract.Add(this);
                }
